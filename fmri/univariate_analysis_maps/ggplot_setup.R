...
th <-  theme(
  ...
  axis.text.x = element_text(hjust = 0.5, size=rel(1.5), color='black'),
  axis.title.x = element_text(size=rel(1.5)),
  axis.ticks.x = element_blank(),
  axis.text.y = element_text(hjust = 1, size=rel(1.5), color='black'),
  axis.title.y = element_text(size=rel(1.5)),
  plot.title=element_text(size=20, vjust=2, hjust=0.0),
...
group_x_axis <- scale_x_discrete(breaks=c('legal', 'lsba', 'mri', 'mturk'), 
                                 labels=group_labels)

#group_x_axis <- scale_x_discrete(breaks=c('legal', 'lsba', 'mri', 'mturk'),
#                                 labels=c('Law Students', 'Louisiana Bar', 'fMRI', 'mTurk'))
...
outcome_corr_labels <- c('Case Strength/\nPunishment',
                         'Confidence/\nOutrage',
                         'Confidence/\nLikelihood',
                         'Confidence/\nThreat',
                         'Threat/\nLikelihood',
